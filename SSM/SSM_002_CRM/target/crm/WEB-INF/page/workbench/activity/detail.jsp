	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#saveCreateActivityRemarkBtn").click(function () {
				...
				//发送请求
				$.ajax({
					url:'workbench/activity/insertActivityRemark.action',
					data:{
			...
			$("#remarkDivList").on("click","a[name='deleteA']",function () {
				...
				//发送请求
				$.ajax({
					url:'workbench/activity/deleteActivityRemark.action',
					data:{
						id:id
					},
					type:'post',
			...
			$("#updateRemarkBtn").click(function () {
				...
				//发送请求
				$.ajax({
					url:'workbench/activity/updateActivityRemark.action',
					data:{
						id:id,
						noteContent:noteContent
					},
