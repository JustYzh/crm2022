...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchActivityTxt").keyup(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/activity/selectActivityForRelationByClueId.action',
				data:{
					name:name,
					clueId:clueId
				},
		...
		<c:forEach items="${clueRemarks}" var="remark">
			<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${clue.fullname}</b> <small style="color: gray;"> ${remark.editFlag=='1'?remark.editTime:remark.createTime} 由${remark.editFlag=='1'?remark.editBy:remark.createBy}${remark.editFlag=='1'?'修改':'创建'}</small>
					...
					<tbody>
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<td>${list.endDate}</td>
								<td>${list.owner}</td>
								<td><a href="javascript:void(0);" activityid="${list.id}" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
